...
<div class="m-grid__item m-grid__item--fluid m-wrapper" >
    ...
    <div class="m-content">
                ...
                <div class="m-portlet m-portlet--mobile  m-portlet--unair">
                        ...
                        <div class="m-portlet__head-caption">
                            <div class="m-portlet__head-title">
                                <h3 class="m-portlet__head-text" style="color: #262626;">
                                    <strong>Student Exam Fee</strong>
                                </h3>
                            </div>
                        </div>
                    ...
                    <div class="m-portlet__head-tools">
                        ...
                        <div class="row m-form  m-form--fit m-form--label-align-right" onsubmit="submit()" style="margin: 14px 0px 0px 11px" >
                            @csrf
                            <input type="hidden" name="old" id="old" value='{{route("api.studentExamFeeGetStudents")}}'>
                            <div class="col-md-3">
                            ...
                            <div class="col-md-3" style="padding-top: 25px">
                                ...
                                <a id="searchExamFee" name="searchExamFee" class="btn m-btn--pill  text-dark  btn-metal" >
                                    Search
                                </a>
        ...
        <div class="row d-none" id="ExamFee">
            <div class="col-md-12">
