                ...
                <div class="m-portlet m-portlet--mobile  m-portlet--unair">
                    ...
                    <div class="m-portlet__head-tools">
                        ...
                        <div class="row m-form  m-form--fit m-form--label-align-right" onsubmit="submit()" style="margin: 14px 0px 0px 11px" >
                            ...
                            <input type="hidden" name="urlGetStudent" id="urlGetStudent" value='{{route("api.marksGetStudent")}}'>
                            <input type="hidden" name="DisplayStudentMark" id="DisplayStudentMark" value='{{route("api.DisplayStudentMark")}}'>
{{--                            <input type="hidden" name="urlGetData" id="urlGetData" value='{{route("api.studentMarksGetStudent")}}'>--}}
                            ...
                            <div class="col-md-2">
                                <div class="form-group  "  >
                                    ...
                                    <select class="form-control m-input m-input--solid" name="examTypeId" id="examTypeId" required="">
                            ...
                            <div class="col-md-2">
                                <div class="form-group  " >
                                    ...
                                    <select class="form-control m-input m-input--solid" name="studentName" id="studentName" required="">
...
{{--                                <a id="searchStudentMarks" onclick="loadPage('{{route('api.studentMarksGetStudent')}}','GET','Changing',1,0);" name="searchStudentMarks" class="btn m-btn--pill  text-dark  btn-metal" >--}}
                                <a id="getStudentMarks"  name="getStudentMarks" class="btn m-btn--pill  text-dark  btn-metal" >
                                    Search
                                </a>
