                ...
                <div class="m-portlet m-portlet--mobile  m-portlet--unair">
                    ...
                    <div class="m-portlet__head-tools">
                        ...
                        <div class="row m-form  m-form--fit m-form--label-align-right" onsubmit="submit()" style="margin: 14px 0px 0px 11px" >
                            ...
                            <input type="hidden" name="DisplayStudentMark" id="DisplayStudentMark" value='{{route("api.DisplayMarkForStudent")}}'>
...
{{--                            </div>--}}{{-- End col md 3 --}}
                            ...
                            <div class="col-md-2" style="padding-top: 25px">
                                ...
                                <a id="StudentMarks"  name="StudentMarks" class="btn m-btn--pill  text-dark  btn-metal" >
                                    Search
                                </a>
