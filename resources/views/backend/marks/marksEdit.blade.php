                ...
                <div class="m-portlet m-portlet--mobile  m-portlet--unair">
                        ...
                        <div class="m-portlet__head-caption">
                            <div class="m-portlet__head-title">
                                <h3 class="m-portlet__head-text" style="color: black">
                                    <strong>Edit Marks Entry</strong>
                                </h3>
                            </div>
                        </div>
                    ...
                    <div class="m-portlet__head-tools">
                        ...
                        <div class="row m-form  m-form--fit m-form--label-align-right" onsubmit="submit()" style="margin: 14px 0px 0px 11px" >
                            ...
                            <input type="hidden" name="urlGetData" id="urlGetData" value='{{route("api.studentMarksGetEdit")}}'>
                            <div class="col-md-3">
...
{{--                                   <a id="searchStudentMarksEdit" onclick="loadPage('{{route('api.studentMarksGetEdit')}}','GET','Changing',1,0);" name="searchStudentMarksEdit" class="btn m-btn--pill  text-dark  btn-metal" >--}}
                                <a id="searchStudentMarksEdit"  name="searchStudentMarksEdit" class="btn m-btn--pill  text-dark  btn-metal" >
                                    Search
                                </a>
                ...
                <div class="m-portlet m-portlet--mobile  m-portlet--unair"style="background-color: #ffffff8f">
                    ...
                    <div class="m-portlet__body" >
                        ...
                        <div  id="m_datatable_latest_orders" >
                            <table class="table table-hover"  style="color: #262626;width: 100%" >
                            ...
                            <input id="submit" type="submit" class="btn m-btn--pill  text-dark  btn-success d-none" value="Update"
                                   onclick="loadPage('{{route('api.marksEntryUpdate')}}','POST','Changing',1,21);">
