                            ...
                            <div class="m-form m-form--fit m-form--label-align-right" onsubmit="submit()"  >
                                ...
                                <div class="m-portlet__body" >
                                    ...
                                    <div class="form-group m-form__group " >
                                        <label for="exampleInputEmail1" style="color: black">
                                           <strong>Field Name<span class="text-danger"> *</span></strong>
                                        </label>
                                        <input type="text" name="name" id="name" class="form-control m-input m-input--solid"  placeholder="Enter name" value="{{$editGroup->name}}">
                                    </div>
                                ...
                                <div class="m-portlet__foot m-portlet__foot--fit">
                                    <div class="m-form__actions">
                                        <button class="btn btn-success" onclick="loadPage('{{route('api.updateStudentGroup',$editGroup->id)}}','post','Changing',1,7);">
                                            Submit
                                        </button>
