                            ...
                            <div class="m-form m-form--fit m-form--label-align-right" onsubmit="submit()"  >
                                ...
                                <div class="m-portlet__body" >
                                    ...
                                    <div class="form-group m-form__group " >
                                        <label for="exampleInputEmail1" style="color: black">
                                           <strong> Student Fee Category<span class="text-danger"> *</span></strong>
                                        </label>
                                        <input type="text" name="feeCatName" id="feeCatName" class="form-control m-input m-input--solid"  placeholder="Enter name" value="{{$editFeeCategory->name}}">
                                    </div>
                                ...
                                <div class="m-portlet__foot m-portlet__foot--fit">
                                    <div class="m-form__actions">
                                        <button class="btn btn-success" onclick="loadPage('{{route('api.updateFeeCategory',$editFeeCategory->id)}}','post','Changing',1,9);">
                                            update
                                        </button>
