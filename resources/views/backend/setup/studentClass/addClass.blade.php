                            ...
                            <div class="m-form m-form--fit m-form--label-align-right" onsubmit="submit()"  >
                                ...
                                <div class="m-portlet__body" >
                                    ...
                                    <div class="form-group m-form__group " >
                                        ...
                                        <input type="text" name="className" id="className" class="form-control m-input m-input--solid"  placeholder="Enter name">
                                    </div>
                                ...
                                <div class="m-portlet__foot m-portlet__foot--fit">
                                    <div class="m-form__actions">
                                        <button class="btn btn-success" onclick="loadPage('{{route('api.storeStudentClass')}}','post','Changing',1,5);">
                                            Submit
                                        </button>
                                        <button type="reset" class="btn btn-secondary" onclick="loadPage('{{route('api.studentClassView')}}','GET','Changing',1,0)">
                                            Cancel
                                        </button>
                                    </div>
                                </div>
