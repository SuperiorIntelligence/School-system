                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group m-form__group " >
                                                ...
                                                <input type="date" name="AttendDate" id="AttendDate" class="form-control m-input m-input--solid" >
                                            </div>
                                        </div>
                                    </div>
                                    <br>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <table class="table table-hover" style="color: #262626;">
                                                ...
                                                @foreach($Employees as $key => $employee)
                                                    <input type="hidden" class="number" name="employeeId[]" id="employeeId{{$key}}" value="{{$employee->id}}">
                                                <tr id="div{{$employee->id}}" class="text-center">
                                                    <td><strong>{{$key+1}}</strong></td>
                                                    <td>{{$employee->name}}</td>
                                                            <td style="text-align: center">
                                                                    <input type="radio" name="attendStatus{{$key+1}}" value="Present" id="present{{$key}}" checked="checked" >
