                        ...
                        <div class="m-portlet__head-caption">
                            <div class="m-portlet__head-title">
                                <h3 class="m-portlet__head-text" style="color: black">
                                    <strong>List Employee Attendance</strong>
                                </h3>
                            </div>
                        </div>
                        ...
                        <div  id="m_datatable_latest_orders">
                            ...
                            <table class="table table-hover" style="color: #262626;">
                                ...
                                @foreach($allData as $key => $attend)
                                    <tr>
                                        ...
                                        <td width="40%">{{date("d-m-Y",strtotime($attend->date)) }}</td>

                                        <td>
                                            <button type="button" class="btn m-btn--pill    btn-warning m-btn m-btn--custom"
                                                    onclick="loadPage('{{route('api.employeeAttendanceEdit',$attend->date)}}','GET','Changing',1,0);">
                                                Edit
                                            </button>
                                            <button type="button" class="btn m-btn--pill    btn-danger m-btn m-btn--custom"
                                                    onclick="loadPage('{{route('api.employeeAttendanceDetails',$attend->date)}}','GET','Changing',1,0);">
                                                Details
                                            </button>
                                        </td>
                                    </tr>
                            ...
                            @if($allData->isEmpty())
                                <div class="col-md-12" style="text-align: center">
                                    <strong><span class="text-danger">No data available in table</span></strong>
                                </div>
                            @endif
