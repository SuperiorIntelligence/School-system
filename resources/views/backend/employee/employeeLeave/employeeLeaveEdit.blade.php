                            ...
                            <div class="m-form m-form--fit m-form--label-align-right" onsubmit="submit()"  >
                                    ...
                                    <div class="row" style="color: #262626;">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group m-form__group">
                                                ...
                                                <input disabled="" type="text"  class="form-control m-input m-input--solid"  value="{{$employees->name}}">
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group m-form__group">
                                                ...
                                                <select class="form-control m-input m-input--solid" name="purpose"  id="purpose" >
                                                    ...
                                                    @foreach($leavePurpose as $purpose)
                                                        <option value="{{$purpose->id}}"{{($editData->leavePurposeId == $purpose->id) ? 'selected':''}}>{{$purpose->name}}</option>
                                                    @endforeach
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group m-form__group " >
                                                ...
                                                <input type="date" name="endDate" id="endDate" class="form-control m-input m-input--solid"  placeholder="Enter Start Date" value="{{$editData->endDate}}">
                                            </div>
                                        </div>
                                ...
                                <div class="m-portlet__foot m-portlet__foot--fit">
                                    <div class="m-form__actions">
                                        <button class="btn btn-success" onclick="loadPage('{{route('api.updateEmployeeLeave',$editData->id)}}','post','Changing',1,19);">
                                            Submit
                                        </button>
