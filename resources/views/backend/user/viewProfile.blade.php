...
{{--                                @csrf--}}
                                <div class="m-portlet__body">
                                    ...
                                    <div class="form-group m-form__group row">
                                        ...
                                        <div class="col-7">
                                            <select class="form-control m-input m-input--solid" disabled name="usertype"  id="usertype" >
                                                <option value="" selected="" disabled="">Select Role</option>
                                                <option value="Admin" {{ ($userWorking->usertype == "Admin" ? "selected":"") }}>Admin</option>
                                                <option value="Employee" {{ ($userWorking->usertype == "Employee" ? "selected":"") }}>Employee</option>
                                                <option value="Student" {{ ($userWorking->usertype == "Student" ? "selected":"") }}>Student</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group m-form__group row">
                                    ...
                                    <div class="m-form__actions">
                                        <div class="row">
                                            ...
                                            <div class="col-7">
                                                ...
                                                &nbsp;&nbsp;
                                                <button type="reset" class="btn btn-secondary " onclick="loadPage('{{route('api.profileView')}}','GET','Changing',1,0)">
                                                    Cancel
                                                </button>
                                            </div>
                                        </div>
