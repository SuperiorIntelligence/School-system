...
{{--                            <img alt="" src="{{asset('backend/assets/demo/demo12/media/img/logo/logo.png')}}"/>--}}
{{--                            <img alt="" src="{{asset('image/website/png-transparent-schoology-learning-management-system-student-department-of-defense-education-activity-exam-text-class-trademark-thumbnail.png')}}"/>--}}
...
{{--													<img src="{{asset('backend/assets/app/media/img/users/user4.jpg')}}" class="m--img-rounded m--marginless m--img-centered" alt=""/>--}}
                                                    <img style="height: 52px" src="{{!empty($userWorking->profile_photo) ? url($userWorking->profile_photo) : url('image\picProfile\no_image.jpg')}}" class="m--img-rounded m--marginless m--img-centered" alt=""/>
												</span>
                                        ...
                                        <div class="m-dropdown__header m--align-center">
                                            <div class="m-card-user m-card-user--skin-light">
                                                <div class="m-card-user__pic">
                                                    <img style="width: 80px;height: 80px" src="{{!empty($userWorking->profile_photo) ? url($userWorking->profile_photo) : url('image\picProfile\no_image.jpg')}}" class="m--img-rounded m--marginless" alt=""/>
{{--                                                    <img src="{{asset('backend/assets/app/media/img/users/user4.jpg')}}" class="m--img-rounded m--marginless" alt=""/>--}}
                                                </div>
                                            ...
                                            <div class="m-dropdown__content">
                                                <ul class="m-nav m-nav--skin-light">
                                                    ...
                                                    <li class="m-nav__item">
                                                        <a href="#" class="m-nav__link" onclick="loadPage('{{route('api.profileView')}}','GET','Changing',1,0)">
                                                    ...
                                                    <li class="m-nav__item">
                                                        <a href="#" class="m-nav__link" onclick="loadPage('{{route('api.changePassword')}}','GET','Changing',1,0)">
...
{{--                                                    </li>--}}
                                                    <li class="m-nav__separator m-nav__separator--fit"></li>
                                                    <li class="m-nav__item">
                                                        <a href="#" class="btn m-btn--pill    btn-secondary m-btn m-btn--custom m-btn--label-brand m-btn--bolder" onclick="loadPage('{{url('api/logout')}}','GET','',2)">
                                                            Logout
                                                        </a>
                                                    </li>
                                                </ul>
