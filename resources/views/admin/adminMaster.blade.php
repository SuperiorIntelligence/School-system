...
{{--        <div id="Changing" style="background-image: url('{{asset("image/backgroundImage/download.jpg")}}');width: 100%;">--}}
        <div id="Changing" style="background-image: url('{{asset("image/backgroundImage/1132838.jpg")}}');width: 100%;">
{{--        <div id="Changing" style="background-image: url('{{asset("image/backgroundImage/photo-1518531933037-91b2f5f229cc.jpg")}}');width: 100%;">--}}
{{--        <div id="Changing" style="background-image: url('{{asset("image/backgroundImage/2048343.jpg")}}');width: 100%;">--}}
{{--        <div id="Changing" style="background-image: url('{{asset("image/backgroundImage/photo-1555505019-8c3f1c4aba5f.avif")}}');width: 100%;">--}}
        @yield("admin")
        </div>
    </div>
...
<script src="{{asset('axios.min.js')}}" integrity="sha512-bZS47S7sPOxkjU/4Bt0zrhEtWx0y0CRkhEp8IckzK+ltifIIE9EMIMTuT/mEzoIMewUINruDBIR/jJnbguonqQ==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>

<script src="{{asset('handlebars.min.js')}}"></script>
