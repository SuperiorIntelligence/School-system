...
class ProfileController extends Controller
{
    ...
    public function profileView(){
        ...
        $userWork = Author::where("remember_token",$_COOKIE['Authorization'])->first();
        return view("backend.user.viewProfile",[
            'userWorking' => $userWork,
            'selected' => 'profile',
        ]);
    ...
    public function updateProfile(Request $request,$id){
        ...
        if($picProfile){
            ...
            $imgExt = strtolower($picProfile->getClientOriginalExtension());    //find type img (jpg, png,... )
